<div class="px-4 py-2 bg-gray-200 bg-indigo-600 lg:w-1/4">
    ...
    <div class="hidden lg:block">
        ...
        <ul>
            ...
            <li class="{{ request()->is('company') ? 'mb-2 bg-gray-800 rounded shadow' : 'mb-2 rounded hover:shadow hover:bg-gray-800' }}">
                <a href="/company" class="inline-block w-full h-full px-3 py-2 font-bold text-white">
            ...
            <li class="{{ request()->is('employee') ? 'mb-2 bg-gray-800 rounded shadow' : 'mb-2 rounded hover:shadow hover:bg-gray-800' }}">
                <a href="/employee" class="inline-block w-full h-full px-3 py-2 font-bold text-white">
                    <svg xmlns="http://www.w3.org/2000/svg" class="inline-block w-6 h-6 mr-2 -mt-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <li class="{{ request()->is('client') ? 'mb-2 bg-gray-800 rounded shadow' : 'mb-2 rounded hover:shadow hover:bg-gray-800' }}">
                <a href="/client" class="inline-block w-full h-full px-3 py-2 font-bold text-white">
                    <svg xmlns="http://www.w3.org/2000/svg" class="inline-block w-6 h-6 mr-2 -mt-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
